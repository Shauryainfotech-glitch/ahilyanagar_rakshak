...
class _AccidentGDFormState extends State<AccidentGDForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Accident GD')),
      body: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              SizedBox(height: 12),
              TextFormField(
                decoration: InputDecoration(labelText: 'Accident Date'),
                onSaved: (value) => accidentDate = value,
              ),
              SizedBox(height: 12),
              TextFormField(
                ...
                onPressed: () {
                  if (_formKey.currentState!.validate()) {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Accident GD submitted!')),
                    );
                  }
                },
                child: Text('Submit'),
