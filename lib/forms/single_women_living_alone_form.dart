...
class SingleWomenLivingAloneForm extends StatefulWidget {
  const SingleWomenLivingAloneForm({super.key});

  @override
  _SingleWomenLivingAloneFormState createState() => _SingleWomenLivingAloneFormState();
}

class _SingleWomenLivingAloneFormState extends State<SingleWomenLivingAloneForm> {
  ...
  final List<String> _genders = ['Female', 'Other'];
    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: [
            Text('Personal Details', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.blue[800])),
            ...
            TextFormField(
              ...
              validator: (value) => value == null || value.isEmpty ? 'Please enter occupation' : null,
